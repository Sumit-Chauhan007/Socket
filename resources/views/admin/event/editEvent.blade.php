                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="mb-3 col-xl-8">
                                        ...
                                        <input type="text" class="form-control" value="{{$event->name}}" id="EventName" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3 col-xl-8">
                                        <label for="EventPlace" class="form-label">Place</label>
                                        <input type="text" class="form-control" id="EventPlace" value="{{$event->place}}" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3 col-xl-8">
                                        <label for="EventDescription" class="form-label">Description</label>
                                        <input type="text" class="form-control" id="EventDescription" value="{{$event->description}}" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3 col-xl-8">
                                    ...
                                    <div class="mb-3 col-xl-8">
                                        ...
                                        <input type="date" class="form-control" id="EventDate" value="{{$event->date}}" aria-describedby="emailHelp">
                                    </div>
                                </div>
                                <button type="button" onclick="addEvent('{{$event->uuid}}')" class="btn btn-primary">Submit</button>
