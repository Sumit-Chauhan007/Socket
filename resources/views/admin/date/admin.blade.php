                        ...
                        <tbody class="table-border-bottom-0">
                            @if (count($date) != 0)
                                @foreach ($date as $key => $event)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src="assets/images/date/{{ $event->image }}" alt=""
                                        ...
                                        <td>
                                            <a href="/edit-date/{{ $event->uuid }}"><button
                                                    class="btn btn-primary">edit event</button></a>
                                            <a href="/delete-date/{{ $event->uuid }}"><button
                                                    class="btn btn-primary">delete event</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
